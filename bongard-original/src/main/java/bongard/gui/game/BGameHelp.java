    ...
    private static class HelpModel implements IBSlidableModel {
        ...
        private class HelpPage implements IBSlidablePage {
            ...
            private void addButtonsOfLastPage(BDrawableContainer cont) {
                ...
                BResourceLocator locator = new BResourceLocator("/help/help.properties");
                Properties props = BResourceLocator.getLocalizedProperties(locator);

                BButton testsButton = BHtmlButton.fromText(props.getProperty("goToTests"), buttonR );
                ...
                testsButton.addClickedListener(new BButton.ClickedListener() {
                    @Override
                    public void clicked(BButton b) {
                        final BSlidableBongardGame d = BPlatform.instance().stateManager().restore(BSlidableBongardGame.class);
                ...
                testsButton.transform().translate(0, 1 * os.h() / 8);
                testsButton.transform().scale(2, 2);
